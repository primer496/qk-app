  ...
  Future<void> _loadRecords() async {
    ...
    try {
      ...
      for (final record in todayRecords) {
        grouped[record.mealType] = (grouped[record.mealType] ?? [])
          ..add(record);
      }
      setState(() {
        _recordsByMeal = grouped;
        _totalCalories = todayRecords.fold(
          0.0,
          ...
          : RefreshIndicator(
              ...
              child: ListView(
                ...
                children: [
                  ...
                  ..._mealOrder.where((meal) => _recordsByMeal.containsKey(meal)).map((
                    meal,
                  ) {
